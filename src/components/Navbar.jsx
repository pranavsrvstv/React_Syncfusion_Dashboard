    ...
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <div className='flex '>
        ...
        <NavButton title="Chat" customFunc={() =>
          handleClick('chat')} color="blue" dotColor="#03C907" icon={<BsChatLeft />} />
        <NavButton title="Notifications" customFunc={() =>
          handleClick('notification')} color="blue" dotColor="#03C907" icon={<RiNotification3Line />} />
        ...
        <TooltipComponent content="Profile" position="BottomCenter">
          <div className='flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg' onClick={() => handleClick('userProfile')}>
            ...
            <p>
              ...
              <span className='text-gray-400 font-bold ml-1 text-14'>Pranav</span>
            </p>
